...
/// <summary>
///     Represents an emulated wired Sony DualSense Edge Controller.
/// </summary>
internal partial class DualSenseEdgeController : ViGEmTarget, IDualSenseController
{
    ...
    /// <inheritdoc />
    /// <summary>
    ///     Initializes a new instance of the <see cref="T:Nefarius.ViGEm.Client.Targets.DualSenseEdgeController" /> class bound
    ...
    public DualSenseEdgeController(ViGEmClient client) : base(client)
    {
        NativeHandle = ViGEmClient.vigem_target_ds_edge_alloc();
    ...
    public DualSenseEdgeController(ViGEmClient client, ushort vendorId, ushort productId) : this(client)
    {
        VendorId = vendorId;
        ProductId = productId;
    }
